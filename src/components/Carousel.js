...
export default function Carousel() {
  ...
  <div className="carousel-inner" id = "carousel">
    <div className="carousel-item active" style = {{maxHeight:"500px"}}>
      <img src="https://source.unsplash.com/random/900×700/?fruit" className="d-block w-100" alt="..." style ={{ objectFit:"cover"}}/>
      <div className="carousel-caption d-none d-md-block">
      <form className="d-flex" >
      <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search"style = {{"zIndex" :"10"}}/>
